        ...
        <div class="w-6/12 bg-white p-6 rounded-lg">
            ...
            <form action="{{ route('register')}}" method="post">
                ...
                <div class="mb-4 mt-2">
                    ...
                    <input type="password" name="password" id="password" placeholder="Create Password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password') border-red-500 @enderror" value="">
                    @error('password')
                    <div class="text-red-500 mt-2 text-sm">
                        {{ $message }}
                    </div>
